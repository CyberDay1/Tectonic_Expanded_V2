...
import dev.worldgen.theexpanse.client.old.gui.widget.FixedStringWidget;
import dev.worldgen.theexpanse.client.old.gui.widget.SliderWidget;
...
import static dev.worldgen.theexpanse.client.old.gui.ConfigScreen.option;
...
public class ConfigList extends ContainerObjectSelectionList<ConfigList.Entry> {
    ...
    public void addBoolean(String name, Consumer<Boolean> setter, boolean value, boolean base) {
        ...
        text.append(Component.translatable("config.theexpanse.default"));
