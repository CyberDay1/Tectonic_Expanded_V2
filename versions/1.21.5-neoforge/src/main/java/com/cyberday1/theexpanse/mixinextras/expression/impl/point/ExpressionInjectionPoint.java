...
import com.cyberday1.theexpanse.mixinextras.expression.impl.ExpressionParserFacade;
...
import com.cyberday1.theexpanse.mixinextras.expression.impl.flow.ComplexDataException;
import com.cyberday1.theexpanse.mixinextras.expression.impl.flow.FlowInterpreter;
import com.cyberday1.theexpanse.mixinextras.expression.impl.flow.FlowValue;
import com.cyberday1.theexpanse.mixinextras.expression.impl.flow.expansion.InsnExpander;
import com.cyberday1.theexpanse.mixinextras.expression.impl.pool.BytecodeIdentifierPool;
...
import com.cyberday1.theexpanse.mixinextras.utils.*;
...
/**
 * See {@link com.cyberday1.theexpanse.mixinextras.expression.Expression @Expression}.
 */
...
public class ExpressionInjectionPoint extends InjectionPoint {
    ...
    private List<String> getMatchingExpressions(MethodNode method) {
        ...
        AnnotationNode expressions = ASMUtils.getRepeatedMEAnnotation(method, com.cyberday1.theexpanse.mixinextras.expression.Expression.class);
